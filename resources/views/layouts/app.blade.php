...
<div class="header">
    ...
    <div class="figure">
        ...
        <div class="parallelogram fourth"></div>
        <div class="rectangle first"></div>
        <div class="rectangle second"></div>
        <div class="rectangle third"></div>
        <div class="rectangle-transparent first"></div>
        <div class="rectangle-transparent second"></div>
    </div>
    ...
    <div class="main">
        ...
        <div class="header-text"><?= $page['short_description'] ?>
        </div>

        <div class="header-buttons">
            <button class="header-button">sites</button>
            <button class="header-button">mobile development</button>
            <button class="header-button">development</button>
            <button class="header-button">marketing</button>
        </div>
