...
<head>
    ...
    <meta name="description" content=" <?= htmlspecialchars($post['meta_description'], ENT_QUOTES) ?>">
    <meta name="keywords" content="<?= htmlspecialchars($post['meta_keywords'], ENT_QUOTES) ?>">
